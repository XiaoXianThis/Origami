...
<video src="https://github.com/XiaoXianThis/Origami/raw/main/web/public/preview.mp4" controls width="100%"></video>

窗口分组、标签切换与无痕隐藏的快速预览。也可在 [产品介绍站](https://origami-c4m.pages.dev/#demo) 体验在线交互演示。
...
| Overlay 切换 | 用窗口快照遮住切换过程，体感更接近瞬时切换 |
...
[![Latest release](https://img.shields.io/github/v/release/XiaoXianThis/Origami?label=download)](https://github.com/XiaoXianThis/Origami/releases/latest)
...
静态站点位于 `web/` 目录，可部署到 Cloudflare Pages。
